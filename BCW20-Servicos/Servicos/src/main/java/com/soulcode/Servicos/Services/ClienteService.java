...
public class ClienteService {
    ...
    @Cacheable(value="clienteCache", key="'chamado'.concat(#id_cliente)")
    public List<List> findByValorPagoPorChamadoConcluido(Integer idCliente){
        return clienteRepository.findByValorPagoPorChamadoConcluido(idCliente);
    }
