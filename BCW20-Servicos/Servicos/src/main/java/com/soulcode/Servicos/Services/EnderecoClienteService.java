...
public class EnderecoClienteService {
    ...
    public EnderecoCliente cadastrarEnderecoDoCliente (EnderecoCliente enderecoCliente, Integer idCliente) throws EntityNotFoundException {
        ...
        if(cliente.isPresent()){
            ...
            throw new EntityNotFoundException("Não foi possível cadastrar o endereço, cliente não existe.");
        }
    }
