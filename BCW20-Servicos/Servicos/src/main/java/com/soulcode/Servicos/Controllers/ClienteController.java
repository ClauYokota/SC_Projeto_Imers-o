...
public class ClienteController {
    ...
    @GetMapping("/clientes/chamado-concluido/{idCliente}")
    public List<List> findByValorPagoPorChamadoConcluido(@PathVariable Integer idCliente){
        List<List> clientes = clienteService.findByValorPagoPorChamadoConcluido(idCliente);
        return clientes;
    }
